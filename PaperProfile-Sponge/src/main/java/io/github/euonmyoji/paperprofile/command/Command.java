...
public class Command {
    //some ide will random sort the static ?????????????
    //use static blocked to inited.

    public static final CommandSpec A;
    public static final CommandSpec NN;
    public static final CommandSpec DICE_HIDE;
    public static final CommandSpec DICE;
    public static final CommandSpec PAPER_PROFILE;

    private static final HashMap<String, Task> commanded = new HashMap<>();

    static {
        A = CommandSpec.builder()
        ...
        PAPER_PROFILE = CommandSpec.builder()
                .executor((src, args) -> {
